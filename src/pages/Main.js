...
import { compareState } from './compare/MobileMatchingCompare';
import PCMatchingCompare from './compare/PCMatchingCompare';
...
function Main() {
  ...
  return (
    <>
      ...
      <PCMatchingCompare data={data} removeItem={removeItem} />
    </>
  );
}
